...
set :markdown, :tables => true, :autolink => true, :gh_blockcode => true, :fenced_code_blocks => true, with_toc_data: true, disable_indented_code_blocks: true, strikethrough: true
