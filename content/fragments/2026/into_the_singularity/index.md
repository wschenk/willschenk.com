...
subtitle: The future is different than the past
tags:
  - ai
  - singularity
date: 2026-02-07
...
was [Opus 4.5](https://www.anthropic.com/news/claude-opus-4-5), maybe
...
[Cursor](https://cursor.com/) and [Claude
Code](https://docs.anthropic.com/en/docs/claude-code/overview). I
...
From the consumer side, I use the [Claude](https://claude.ai/) app
and [Gemini](https://gemini.google.com/) a lot. I rarely use
[ChatGPT](https://chatgpt.com/) anymore -- only for the voice stuff
