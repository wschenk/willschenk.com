...
#+begin_src elisp :tangle ~/.emacs.d/local/claude.el
  ...
  ;; Force dark background in eat buffers for consistent Claude colors
  ;; This ensures Claude's terminal colors display correctly regardless
  ;; of your Emacs theme (light or dark)
  (defun my/eat-force-dark-background ()
    "Force dark background and high-contrast colors for eat buffers."
    (face-remap-add-relative 'default :background "#1e1e1e" :foreground "#e0e0e0")
    ;; Remap all colors for good contrast on dark background
    (face-remap-add-relative 'eat-term-color-0 :foreground "#808080")   ; black -> medium gray
    (face-remap-add-relative 'eat-term-color-1 :foreground "#ff6b6b")   ; red
    (face-remap-add-relative 'eat-term-color-2 :foreground "#69ff94")   ; green
    (face-remap-add-relative 'eat-term-color-3 :foreground "#ffff6b")   ; yellow
    (face-remap-add-relative 'eat-term-color-4 :foreground "#6bb5ff")   ; blue
    (face-remap-add-relative 'eat-term-color-5 :foreground "#ff6bff")   ; magenta
    (face-remap-add-relative 'eat-term-color-6 :foreground "#6bffff")   ; cyan
    (face-remap-add-relative 'eat-term-color-7 :foreground "#ffffff")   ; white
    (face-remap-add-relative 'eat-term-color-8 :foreground "#a0a0a0")   ; bright black
    (face-remap-add-relative 'eat-term-color-9 :foreground "#ff8a8a")   ; bright red
    (face-remap-add-relative 'eat-term-color-10 :foreground "#8affb0")  ; bright green
    (face-remap-add-relative 'eat-term-color-11 :foreground "#ffff8a")  ; bright yellow
    (face-remap-add-relative 'eat-term-color-12 :foreground "#8ac5ff")  ; bright blue
    (face-remap-add-relative 'eat-term-color-13 :foreground "#ff8aff")  ; bright magenta
    (face-remap-add-relative 'eat-term-color-14 :foreground "#8affff")  ; bright cyan
    (face-remap-add-relative 'eat-term-color-15 :foreground "#ffffff")) ; bright white
